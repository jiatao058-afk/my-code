 ...
 */
package com.taoji.wifiheatmap.wifi.manager
...
import com.taoji.wifiheatmap.util.buildMinVersionR
...
class WiFiManagerWrapper(
    ...
    fun is6GHzBandSupported(): Boolean =
        if (minVersionR()) wifiManager.is6GHzBandSupported else false

    fun isScanThrottleEnabled(): Boolean =
        if (minVersionR()) isScanThrottleEnabledR() else false
